class Client {
    ...
    static async getAvailable(basePath = "") {
        ...
        let toc;
        try {
            toc = JSON.parse(await Tools.fetch(basePath + "circuitpy/lib/pyswitch/clients/toc.php"));
        } catch (_) {
            toc = JSON.parse(await Tools.fetch(basePath + "circuitpy/lib/pyswitch/clients/toc.json"));
        }
