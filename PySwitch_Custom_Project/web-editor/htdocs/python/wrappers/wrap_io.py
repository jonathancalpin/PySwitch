...
class WrapDigitalIO:
    ...
    class DigitalInOut:
        ...
        def value(self):
            ...
            pushed = getattr(self.element.dataset, 'pushed', None)
            if pushed is None:
                return 1

            return 0 if pushed == "true" else 1
...
class WrapAnalogIO:
    ...
    class AnalogIn:
        ...
        def value(self):
            ...
            val = getattr(self.element.dataset, 'value', None)
            if val is None:
                return 0
            return int(val)
...
class WrapRotaryIO:
    ...
    class IncrementalEncoder:
        ...
        def position(self):
            ...
            pos = getattr(self.element.dataset, 'position', None)
            if pos is None:
                return 0
            return int(pos)